export default function Footer(){
  ...
  <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 items-center">
    {/* Brand / Copyright – left or center on mobile */}
    ...
    {/* Quick links – optional but very useful for portfolios */}
    ...
    {/* Social icons – matching your emerald theme */}
    <div className="flex justify-center md:justify-end gap-6">
      ...
      >
        {/* GitHub icon – use react-icons or SVG */}
      ...
      <a 
        href="https://www.linkedin.com/in/avith-apolinary-52a651396" 
        target="_blank" 
        rel="noopener noreferrer"
        className="text-gray-400 hover:text-emerald-400 transition-colors transform hover:scale-110"
      >
      ...
      {/* Add more icons if you have Twitter/X, etc. */}
    </div>
  </div>
</footer>
        </>
